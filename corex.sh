...
show_help() {
    ...
    echo "  manage disk shared-plan    Inspect a legacy Time Machine partition layout"
    echo "  manage cold status         Show wake-on-access and model idle settings"
    echo "  manage cold enable portainer  Let Portainer sleep and wake on HTTPS"
    echo "  manage cleanup [options]   Remove stale Docker images and build cache"
