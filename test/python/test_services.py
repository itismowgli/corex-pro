...
class ServiceTests(unittest.TestCase):
    ...
    def test_keeper_generates_private_stable_secrets_and_limited_compose(self):
        ...
        self.assertIn('BUN_OPTIONS: "--smol"', compose)
        self.assertIn('WORKER_CONCURRENCY: "1"', compose)
        self.assertIn('DATABASE_POOL_MAX: "2"', compose)
        self.assertIn('CRON_FLUSH_POOL_MAX: "1"', compose)
